...
<div>
	...
	<div class="mp_top">
		...
		<div class="r"><!-- right layout -->
			<!-- 부서일정관리  -->
			<h3 class="m_tit01 mt15"><spring:message code="comSymMnuMpm.mainView.selectBBSListPortlet"/></h3><!-- 생성된 게시물 -->
			<div style="height:150px">
			</div>
			
			<!-- 나의일정관리 -->
			<h3 class="m_tit01 mt15"><spring:message code="comSymMnuMpm.mainView.selectBBSListPortlet"/></h3><!-- 생선된 게시물 -->
			<div style="height:150px">
			</div>
