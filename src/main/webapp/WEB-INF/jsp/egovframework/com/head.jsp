...
<script type="text/javascript" src="/js/egovframework/com/main.js"></script>
<link type="text/css" rel="stylesheet" href="/css/egovframework/com/main_portal.css">
...
<input name="chkURL" type="hidden" />
    <div id="gnb">
    <div id="top_logo">
    	<a href="/sym/mnu/mpm/EgovMainMenuHome.do" target=_top>
    		<img src="/images/egovframework/com/cmm/main/logo_01.gif" alt="egovframe" />
    	</a>
    </div>
    <div id="use_descri">
            <ul>
